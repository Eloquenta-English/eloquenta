...
- A server with Ubuntu 22.04 (Oracle Cloud Free Tier works great and is free; Hetzner or any VPS with Node.js also works)
...
- Oracle Cloud Free Tier: **$0/month** (4 CPU, 24GB RAM) — best free option. Hetzner CX11: **€3.50/month** (2 CPU, 4GB RAM) if you prefer a paid VPS.
